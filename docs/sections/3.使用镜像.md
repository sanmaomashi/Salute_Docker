...
!>Docker 运行容器前需要本地存在对应的镜像，如果本地不存在该镜像，Docker 会从镜像仓库下载该镜像。默认是从 Docker Hub 公共镜像源下载。
...
![20211010214034](/Users/zhougaofeng/Desktop/Salute_系列/Salute_Docker/img/12.jpg)
...
![20211010222544](/Users/zhougaofeng/Desktop/Salute_系列/Salute_Docker/img/13.png)
...
![20211010222549](/Users/zhougaofeng/Desktop/Salute_系列/Salute_Docker/img/14.png)
...
## 11、构建多种系统架构支持的 Docker 镜像 -- docker manifest 命令详解
...
### 12.2 Docker 镜像的导入和导出 `docker save` 和 `docker load`
